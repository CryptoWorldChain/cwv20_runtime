...
cd /opt/bruntime
rm -rf felix-cache/
#sbin/bcprov-jdk16-140.jar:
java -cp sbin/felix.jar:sbin/protobuf-java-3.6.1.jar -DofwConf=conf/ofw.properties  -Dlogback.configurationFile=conf/logback-server.xml ${JAVA_OPTS} org.apache.felix.main.Main